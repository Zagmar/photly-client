...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/amplify_analytics_pinpoint_ios/amplify_analytics_pinpoint_ios.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/amplify_api/amplify_api.framework"
